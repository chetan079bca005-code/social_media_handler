...
export const analyticsApi = {
  getSummary: (params?: { startDate?: string; endDate?: string; platform?: string }) =>
    request<any>({
      method: 'GET',
  ...
  getTopPosts: (params?: { limit?: number; startDate?: string; endDate?: string }) =>
    request<any[]>({
      method: 'GET',
      url: '/analytics/top-posts',
      params,
    }),

  getEngagementTrends: (params?: { startDate?: string; endDate?: string; granularity?: string }) =>
    request<any[]>({
      method: 'GET',
