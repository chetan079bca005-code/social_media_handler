...
- Tip: Keep backend notes compact enough to read before a push.
- Tip: Keep backend notes easy to scan in one pass before pushing.
...
- Tip: Keep backend docs bullets focused on one check per line.
- Tip: Keep backend docs bullets short enough to review in a single pass.
- Tip: Keep backend docs notes grouped by a single verification intent.
- Tip: Keep one backend note tied to a single check or command.
- Tip: Keep one backend note focused on a single command or check.
